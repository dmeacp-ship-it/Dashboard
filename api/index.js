...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const routes = {
      ...
      getStateQoQ: () => DataService.getStateQoQ(scopedFilters),
      getStateMonthlySummary: () => DataService.getStateMonthlySummary(scopedFilters),
      getStateAllFYSummary: () => DataService.getStateAllFYSummary(scopedFilters),
      getCityQoQ: () => DataService.getCityQoQ(scopedFilters),
      getCityMonthlySummary: () => DataService.getCityMonthlySummary(scopedFilters),
      getCityAllFYSummary: () => DataService.getCityAllFYSummary(scopedFilters),
